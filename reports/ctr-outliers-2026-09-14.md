# CTR Outliers: 2026-09-14

**Period:** last 28 days
**Queries examined:** 119 (position 10 or better, 20+ impressions)
**Underperforming:** 70 across 53 pages
...
| Query | Position | Impressions | Clicks | CTR | Normal | Gap |
|-------|----------|-------------|--------|-----|--------|-----|
| titans abroad | 1.1 | 264 | 7 | 2.7% | 28.0% | 91% below |

**Roughly 67 clicks a month are going to someone else.** Rewrite the page title and meta description around: "titans abroad".
...
| Query | Position | Impressions | Clicks | CTR | Normal | Gap |
|-------|----------|-------------|--------|-----|--------|-----|
| titans abroad | 1.2 | 193 | 4 | 2.1% | 28.0% | 93% below |
...
| Query | Position | Impressions | Clicks | CTR | Normal | Gap |
|-------|----------|-------------|--------|-----|--------|-----|
| mbbs in russia for pakistani students | 7.1 | 111 | 2 | 1.8% | 4.0% | 55% below |
...
| Query | Position | Impressions | Clicks | CTR | Normal | Gap |
|-------|----------|-------------|--------|-----|--------|-----|
| toyohashi university of technology mext scholarship | 6.1 | 44 | 1 | 2.3% | 5.0% | 55% below |
...
| Query | Position | Impressions | Clicks | CTR | Normal | Gap |
|-------|----------|-------------|--------|-----|--------|-----|
| titans abroad | 1.0 | 74 | 5 | 6.8% | 28.0% | 76% below |
...
| Query | Position | Impressions | Clicks | CTR | Normal | Gap |
|-------|----------|-------------|--------|-----|--------|-----|
| ares scholarship belgium | 7.0 | 42 | 0 | 0.0% | 4.0% | 100% below |
...
| Query | Position | Impressions | Clicks | CTR | Normal | Gap |
|-------|----------|-------------|--------|-----|--------|-----|
| germany fully funded scholarships for pakistani students | 1.8 | 53 | 2 | 3.8% | 15.0% | 75% below |

**Roughly 6 clicks a month are going to someone else.** Rewrite the page title and meta description around: "germany fully funded scholarships for pakistani students".
...
| Query | Position | Impressions | Clicks | CTR | Normal | Gap |
|-------|----------|-------------|--------|-----|--------|-----|
| titans abroad | 1.2 | 48 | 2 | 4.2% | 28.0% | 85% below |
...
| Query | Position | Impressions | Clicks | CTR | Normal | Gap |
|-------|----------|-------------|--------|-----|--------|-----|
| ceepus scholarship | 8.7 | 46 | 0 | 0.0% | 2.8% | 100% below |
